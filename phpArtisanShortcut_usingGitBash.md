...
```bash
  ...
  alias lara6x="composer create-project --prefer-dist laravel/laravel blog '6.&ast;'"
  alias lara7="composer create-project --prefer-dist laravel/laravel blog '7'"
  alias lara7x="composer create-project --prefer-dist laravel/laravel blog '7.&ast;'"
  ```
